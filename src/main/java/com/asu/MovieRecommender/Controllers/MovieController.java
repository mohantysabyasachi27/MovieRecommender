...
public class MovieController {
	 ...
	 * @return JSONObject
	 */
	@ApiOperation(value = "Service to get the list of movies", nickname = "Now Playing Movies", response = JSONObject.class, produces = "application/json")
